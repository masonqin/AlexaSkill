...
public class MySpeechlet implements Speechlet {
    ...
    public SpeechletResponse onIntent(final IntentRequest request, final Session session)
        ...
        if ("HelloEmmaIntent".equals(intentName)) {
    		...
    		return homeresponse.getColorLightResponse("on");
        } else if("TurnOffColorLightIntent".equals(intentName)){
        	return homeresponse.getColorLightResponse("off");
        } else if("TurnKettleOnIntent".equals(intentName)){
        	return homeresponse.getKettleResponse("on");
    ...
    private SpeechletResponse getWelcomeResponse() {
        String speechText = "Welcome to the Emma's home, you can say hello Emma";

        // Create the Simple card content.
        SimpleCard card = new SimpleCard();
        card.setTitle("HelloEmma");
    ...
    private SpeechletResponse getHelloResponse() {
        String speechText = "Hello Dear";

        // Create the Simple card content.
        SimpleCard card = new SimpleCard();
        card.setTitle("HelloDear");
        card.setContent(speechText);
    ...
    private SpeechletResponse getHelpResponse() {
        ...
        String speechText = "You can say hello to me, " 
        				  + "ask me to turn on/off color light, "
        				  + "get the light intensity "
        				  + "or turn on/off the kettle!";
        // Create the Simple card content.
        SimpleCard card = new SimpleCard();
        card.setTitle("Help");
        card.setContent(speechText);
